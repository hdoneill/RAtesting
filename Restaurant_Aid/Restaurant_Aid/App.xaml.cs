...
namespace Restaurant_Aid
{
    ...
    public partial class App
    {
        ...
        public static MobileServiceClient MobileService = new MobileServiceClient("https://restaurantaid.azurewebsites.net");
        public static string ApplicationURL = @"https://restaurantaid.azurewebsites.net";
    }
